...
$tickets = getScheduledTicketsByWorker($conn, $_SESSION['s_uid'], false);
$terms = "";

if (!empty($tickets)) {
    $searchIn = implode(",", array_column($tickets, 'ticket'));
    $terms = " OR o.numero IN ($searchIn)";
}
...
$sql = $QRY["tickets_in_queues_count"] . " AND 
            ...
            ( o.operador = {$_SESSION['s_uid']} {$terms} ) AND 
            o.oco_scheduled = 0 
        ";
