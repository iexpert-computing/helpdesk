# 1. Construir a imagem: Inclua a tag 6.0 durante a construção:
  # docker build -t iexpertcomputing/helpdesk:6.0 .
# 2. Enviar a imagem para o Docker Hub: Certifique-se de que o nome e a tag estejam corretos ao fazer o push:
  # docker push iexpertcomputing/helpdesk:6.0
